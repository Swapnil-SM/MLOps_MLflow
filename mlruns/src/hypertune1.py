...
# Load the Breast Cancer dataset (this will be displayed on your local MLflow UI)
...
with mlflow.start_run() as parent:
    ...
    # log all the child runs(means to store all the hyperparameter combinations and their scores first use as parent in mlflow.start_run)
    ...
    # Set tags
    mlflow.set_tag("author", "Swapnil")

    print(best_params)
    print(best_score)
   # (this will be displayed on your local MLflow UI)